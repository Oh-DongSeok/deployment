...
function createFileListPageHtml()
{
	...
	fileListPag.appendChild(Common.getNewElement("div", {id:"txt_FL_SelectInfo1", className:"lbl"}));
	fileListPag.appendChild(Common.getNewElement("div", {id:"txt_FL_SelectInfo2", className:"lbl"}));
