    ...
    public struct ItemType
    {
        ...
        public static PJL StringToPJL (string strType)
        {
            ...
            switch (strType)
            {
                ...
                case PDL.Constants.PJLVariable.JobExecutionTicket:
                    return PJL.JobTicket;
                ...
                case PDL.Constants.PJLVariable.EconomyMode:
                    return PJL.EconomyMode;

                case PDL.Constants.PJLVariable.FxTonerSave:
                    return PJL.TonerSave;
