...
function getFaxFileName()
{
	...
	// timestamp + deviceId + serialnumber + price + faxnumber
	//var result = timestamp + "_" + glbDeviceInfo.serialNumber + "_" + glbSetting.FaxNumber;
	if(glbDataSet.priceInfo){
		...
		//var result = timestamp + "_" + glbJobLogInfo.deviceId +"_" + "fxkissec" + "_" + glbDataSet.priceInfo.totalPrice + "_" + glbSetting.FaxNumber;
	}else{
		var result = timestamp + "_" + glbJobLogInfo.deviceId +"_" + glbDeviceInfo.serialNumber + "_" + glbSetting.FaxNumber;
		//var result = timestamp + "_" + glbJobLogInfo.deviceId +"_" + "fxkissec" + "_" + glbSetting.FaxNumber;
	}
 ...
 *************************************************************/
 function getBridgeUserInfo(clientid){
	var url = HTTP_PROTOCOL + clientid + ":" + CLIENT_PORT + "/bridgeapp/main/information";
 ...
 *************************************************************/
 function getClientStatus(clientid){
	var target = clientid+":"+ CLIENT_PORT;
