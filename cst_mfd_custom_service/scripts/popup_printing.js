...
PrintingPopup._initModel=function()
{
	this._data=
	{
		...
		textList:[
		          {id:"lbl_printing_progress", text:Msg.PrintingPopup.lblRequestCardPayment} //2016.05.12 chone 프린팅 화면 결제 금액 표시 개선 요청
		]
	};
...
PrintingPopup.updateDisplay = function(){
	...
	if(glbInfo.screenType == BrowserLib.ScreenType.WSVGA_ALL_SCREEN){
		Common.setPosition("pop_printingPopup","left","112px");
	}
