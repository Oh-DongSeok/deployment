 ...
 * @lang en
 */
SSMILib.PriceJetWorkInfo = function()
{
	this.cmd = "pay";
	this.jobType 	= "";
	this.totalAmount = 0;
 ...
 * @private
 */
Extend(SSMILib.PriceJetWorkInfo.prototype, XMLLib.SOAPMsg.prototype);

/**
 * @private
 */
SSMILib.PriceJetWorkInfo.prototype.createMsg = function()
{
 ...
 * @lang en
 */
SSMILib.PriceJetWorkRequest = function(sdObj, timeout, remoteHost, type)//2017.11 KIS [v1.5] SmartUI 복수의 Print Server 대응 refs #4502
{
	...
	if(timeout){
		req.timeout = timeout;
		req.ontimeout = SSMILib.PriceJetWorkInfo.gsdErrorCb;
	}
        ...
        if(this.readyState === 4){
        	if(this.status === 200){
        		...
        		if(resObj && typeof resObj.status != "undefined"){
        			...
        			SSMILib.PriceJetWorkInfo.gsdErrorCb();
        		}
	        }else{
	        	SSMILib.PriceJetWorkInfo.gsdErrorCb();
	        }
 ...
 * @private
 */
SSMILib.PriceJetWorkInfo.gsdSuccessCb = function(res)
{
 ...
 * @private
 */
SSMILib.PriceJetWorkInfo.gsdErrorCb = function()
{
