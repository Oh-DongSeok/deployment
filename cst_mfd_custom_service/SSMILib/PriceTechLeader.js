 ...
 * @private
 */
Extend(SSMILib.PriceInfo.prototype, XMLLib.SOAPMsg.prototype);

/**
 * @private
 */
SSMILib.PriceInfo.prototype.createMsg = function()
{
	...
	itNode = xml.createElement("price");
 ...
 * @lang en
 */
SSMILib.PriceRequest = function(sdObj, timeout, remoteHost, type)//2017.11 KIS [v1.5] SmartUI 복수의 Print Server 대응 refs #4502
{
	//SmartUI 2.0 Enhance 2015.05 Start
	//var url = glbConfig.remoteHost + "RegisterCard";
	var url = remoteHost + "api/interface/CardReader/" + type;//2017.11 KIS [v1.5] SmartUI 복수의 Print Server 대응 refs #4502
	...
	if(timeout){
		req.timeout = timeout;
		req.ontimeout = SSMILib.PriceInfo.gsdErrorCb;
	}
 ...
 */
/*
SSMILib.PriceInfo.gsdSuccessCb = function(res)
{
 ...
 * @private
 */
SSMILib.PriceInfo.gsdErrorCb = function()
{
