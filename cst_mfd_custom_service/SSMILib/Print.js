 ...
 * [POST]/api/interface/Print/Send 전달받은 UUID값을 기준으로 저장된 spool 파일을 출력
 * @lang ja
 */
/**
...
SSMILib.PrintSelectedPrnInfo = function(sdObj, timeout, remoteHost)//2017.11 KIS [v1.5] SmartUI 복수의 Print Server 대응 refs #4502
{
	...
	var url = remoteHost + "api/interface/Print/Send";//2017.11 KIS [v1.5] SmartUI 복수의 Print Server 대응 refs #4502
