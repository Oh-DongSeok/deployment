 ...
 *
 * To use these classes, XML.js must be loaded.<br>
 * @author Copyright(C) 2007-2010 FujiXerox Co., Ltd. All rights reserved.
 * @version 2.3.0
 * @lang en
 */
...
JFLib.OutputProcess = function()
{
	 ...
	 *	■使用例 
	 *		--文字列の場合--
	 *		this.workSpace = '＜jt:WorkSpace xmlns:jt="http://www.fujixerox.co.jp/2003/12/ssm/jobTemplate" ＞<br>＜jt:Name＞name＜/jt:Name＞<br>＜jt:Description＞this is a test.＜/jt:Description＞<br>＜/jt:WorkSpace＞'<br>
	 *		のように指定する
	 *	■制限事項 
