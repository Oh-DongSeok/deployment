 ...
 * @lang en
 */
SSMILib.ListCsv = function(name, count, from, after, auth)
{
  ...
  _ws.soapAction = '"http://www.fujixerox.co.jp/2007/07/ssm/management/csv#ListCsv"';
  _ws.isDeviceReq = true;
  
  if(auth || auth === undefined) { //互換性維持のため
...
SSMILib.ListCsv.successCb = function(res)
{
  ...
  var _resNode = res.responseXML.getElementsByTagNameNS("http://www.fujixerox.co.jp/2007/07/ssm/management/csv", "ListCsvResponse");
