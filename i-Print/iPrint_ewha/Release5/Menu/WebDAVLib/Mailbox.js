...
WebDAVLib.Mailbox.prototype.listDocs = function(user, pass)
{
	...
	var msg = '<?xml version="1.0" encoding="utf-8" ?><D:propfind xmlns:D="DAV:" xmlns:sss="http://www.fujixerox.co.jp/2003/12/ssm/storageService"><D:prop><D:displayname/><sss:Origin/></D:prop></D:propfind>';
	var _ws = new WebServiceLib.Communicator();
	if(user || pass)
	{
		_ws.user = user;
