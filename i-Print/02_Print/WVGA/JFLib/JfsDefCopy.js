/** 
 * @fileoverview ジョブフローにおけるコピージョブを扱うクラスで使用される定数を定義する<br>
 * これらの定数を使うためには
 * <ul>
 * <li>JfsDefScan.js
 * <li>JfsDefPrint.js
 ...
 */
/** 
 * @fileoverview Defines constants used in Job Flows which include Copy jobs.<br>
 ...
 * <li>JfsDefPrint.js
 * </ul>
 * are loaded automatically.<br><br>
