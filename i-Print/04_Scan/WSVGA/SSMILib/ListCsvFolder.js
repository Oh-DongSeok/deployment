...
SSMILib.ListCsvFolder = function(name, count, from, after)
{
	...
	_ws.soapAction = '"http://www.fujifilm.com/fb/2021/01/ssm/management/csv#ListCsvFolder"';
...
SSMILib.ListCsvFolder.successCb = function(res)
{
	...
	var _resNode = res.responseXML.getElementsByTagNameNS("http://www.fujifilm.com/fb/2021/01/ssm/management/csv", "ListCsvFolderResponse");
