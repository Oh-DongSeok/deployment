...
ConfirmPopup._initModel=function()
{
	...
	{
		buttonList:[
			{id:"btn_CF_confirm", type:WidgetLib.ButtonType.NORMAL, attr:{targetImgId :"img_CF_confirm", offImg: Img.ICN_CF_CONFIRM_OFF, pressImg: Img.ICN_CF_CONFIRM_PRESS}},
			{id:"btn_CF_cancel", type:WidgetLib.ButtonType.NORMAL, attr:{targetImgId :"img_CF_cancel", offImg: Img.ICN_CF_CANCEL_OFF, disableImg: Img.ICN_CF_CANCEL_PRESS}},
		],
		imageList:[
			//{id:"img_CF_BG", src:Img.IMG_CF_BG}
		],
		textList:[
			{id	:	"lbl_CF_Guide",	text:	""},
			{id	:	"lbl_CF_confirm",	text:	Msg.CONFIRM.BTN_CONFIRM},
			{id	:	"lbl_CF_cancel",	text:	Msg.CONFIRM.BTN_CANCEL},
		]
	};
};
...
ConfirmPopup.updateDisplay=function(){
	Common.setText("lbl_CF_confirm",Msg.CONFIRM.BTN_CONFIRM);
	Common.setText("lbl_CF_cancel",Msg.CONFIRM.BTN_CANCEL);
};
