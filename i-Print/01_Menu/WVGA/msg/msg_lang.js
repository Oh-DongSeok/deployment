...
var Msg_lang = {
	en:{
		...
		LOGIN:{
			...
			LOGIN_BTN_LABEL : "Start", //2017.02 FXKIS IPrint-One Time ID 지원(OTID) 기능판 개발 refs #4230
			DRCT_PRINT_BTN_LABEL :"Direct Print",
			GUIDE_ID:"ID",
			GUIDE_PW:"PASSWORD"
		},
		OTID : { //2017.02 FXKIS IPrint-One Time ID 지원(OTID) 기능판 개발 refs #4230
	...
	ko:{
		...
		LOGIN:{
			LOGIN_ID_LABEL : "ID",
			LOGIN_PW_LABEL : "PASSWORD",
			LOGIN_BTN_LABEL : "시작", //2017.02 FXKIS IPrint-One Time ID 지원(OTID) 기능판 개발 refs #4230
		...
		ERROR_MESSAGE:{
			...
			FAIL_KEY:["대응할 수 없는 기종이거나,", "활성화 키를 잘못 입력했습니다."],
	...
	ja:{
		Common : {
			...
			UnknownUserName : "_No User",
			title : "オールインワンサービス", //TODO Message
			tray_unit: "단",
			tray_bar:"-",
			tray_error: "ERROR",
			CS_NUMBER: "CS-RM-XXXX0",//コンテンツ識別子
