 ...
 * また、本ライブラリをロードすると、
 * <ul>
 * <li>ToolsLib/Base64.js
 * </ul>
 * が自動的にロードされる。
 * @author Copyright(C) 2007-2013 Fuji Xerox Co., Ltd. All rights reserved.<br>
 * @version 2.2.1
 * @lang ja
 */
...
WebServiceLib.Communicator.prototype.send = function(url, msg)
{
  ...
  if(typeof(netscape) != 'undefined') {
	...
	if (typeof(netscape.security.PrivilegeManager) != 'undefined') {
...
WebServiceLib.Communicator.prototype.callJobExecService = function(jobTemplate, host)
{
  ...
  return this.send(SSMILib.protocol + _host + "/ssm/Management/JobTemplate/Execution", jobTemplate);
};
