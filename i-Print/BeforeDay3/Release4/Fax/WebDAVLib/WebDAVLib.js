 ...
 * また、BrowserExt、WebServiceLib、XMLLibをインクルードすることが利用条件となる。<br>
 * ContentsLibを利用する場合には、ContentsLib.jsの前にWebDAVLib.jsをインクルードする必要がある。<br>
 ...
 * BrowserExt, WebServiceLib, and XMLLib is required to use this library.<br>
 * To use ContentsLib, WebDAVLib.js must be included before ContentsLib.js.<br>
 * @author Copyright(C) 2010 Fuji Xerox Co., Ltd. All rights reserved.
 * @version 1.0.0
 * @lang en
 */
