...
var Msg_lang = {
	en:{
		...
		ERROR_MSG:{
			//공통
			FAIL_NOT_INPUT_USER_INFO : ["Please enter your e-mail."],
		...
		Page:{
			Main:{
				inputInfo: "Enter your email address",
				inputInfo2: "Result to receive phone number",
				destAddInput : "Input Address",
				numberAddInput : "Input Tel No",
	...
	ko:{
		...
		ERROR_MSG:{
			//공통
			FAIL_NOT_INPUT_USER_INFO : ["이메일을 입력해주세요."],
		...
		Page:{
			Main:{
				inputInfo: "메일주소 입력",
				inputInfo2: "결과 수신할 전화번호",
				destAddInput : "주소 입력",
				numberAddInput : "전화번호 입력",
				titPageType : "원고방향",
			...
			Etc:{
				...
				lblBgElimination : "배경삭제", //2016.09.28 KIS Chone 용어 변경 refs #4070
				lblImageMode : "원고종류",
				lblDarkness : "농도",
				lblPageSplit:"책복사"
			},
	...
	ja:{
		...
		ERROR_MSG:{
			//공통
			FAIL_NOT_INPUT_USER_INFO : ["メールアドレスを入力してください。"],
		...
		Comflict : {
			colorMode : "カラーモードを[カラー]に変更しました",
			docFormat : "ドキュメントの種類を[PDF]に変更しました"
		},
		Page:{
			Main:{
				inputInfo: "メールアドレスを入力してください",
				inputInfo2: "結果受信する電話番号",
				destAddInput : "アドレス入力",
				numberAddInput : "電話番号を入力",
				titPageType : "入力方向",
	...
	ch:{
		...
		ERROR_MSG:{
			//공통
			FAIL_NOT_INPUT_USER_INFO : ["请输入您的电子邮件."],
		...
		Comflict : {
			colorMode : "将颜色模式更改为 [颜色]",
			docFormat : "将文档类型更改为 [PDF]"
		},
		Page:{
			Main:{
				inputInfo: "输入您的电子邮件地址",
				inputInfo2: "结果收到电话号码",
				destAddInput : "输入地址",
				numberAddInput : "输入你的电话号码",
				titPageType : "输入方向",
