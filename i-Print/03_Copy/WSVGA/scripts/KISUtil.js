...
KISUtil.initDebug = function(body_ID)
{
	if(glb_debug_mode){
		...
		if(flg_Dummy_Beep){
			...
			beepElement.setAttribute("style","position:absolute;top:0px;left:1034px;" +
