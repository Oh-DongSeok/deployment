	...
	en:{
		...
		Page:{
			...
			ChargeInfoPopup:{
				...
				btnCyberConfirm:"Payment to i-money",
				btnCancel:"Cancel",
				//msg1:"Charge is ",
				//msg2:"Won.",
	...
	ko:{
		...
		Page:{
			...
			Etc:{
				...
				lblBgElimination : "배경색 삭제", //2016.09.28 KIS Chone 용어 변경 refs #4070
				lblImageMode : "원고종류",
				lblDarkness : "농도",
				lblPageSplit:"책복사"
			},
	...
	ja:{
		...
		Page:{
			...
			ChargeInfoPopup:{
				...
				btnCyberConfirm:"i-moneyの支払い",//2016.05.25 chone 다언어대응
				btnCancel:"キャンセル",
				oms:"出力用紙サイズ:",
				colorMode:"出力色:",
				pages:"元の文書の数:",
	...
	ch:{
		...
		Page:{
			...
			ChargeInfoPopup:{
				...
				btnCyberConfirm:"支付给网络赚钱(i-money)",
				btnCancel:"取消",
				oms:"输出纸张尺寸:",
				colorMode:"输出颜色:",
				pages:"原始文档的数量:",
