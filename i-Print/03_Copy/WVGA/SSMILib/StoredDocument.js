...
SSMILib.DocumentBox = function(){
  ...
  /**
   *  ボックスIDを指定する<br>
   *  値を指定しない場合は属性(boxId)が生成されない（1.2.1以前）<br>
   *  値を指定しない場合は属性(boxId)が生成される（1.3.0以降）
   *  @type String
   *  @default なし
   *  @lang ja
   */
  ...
  /**
   *  ボックスパスワードを指定する<br>
   *  値を指定しない場合は属性(boxPassword)が生成されない（1.2.1以前）<br>
   *  値を指定しない場合は属性(boxPassword)が生成される（1.3.0以降）
   *  @type String
   *  @default なし
   *  @lang ja
   */
...
SSMILib.StoredDocument.prototype.createMsg = function()
{
  ...
  var mbtNS = "http://www.fujifilm.com/fb/2021/04/ssm/management/mailbox/boxtype";
  var attrNS  = "http://www.fujifilm.com/fb/2021/04/ssm/management/attribute";
  var sdNS    = "http://www.fujifilm.com/fb/2021/04/ssm/management/storeddocument";
  var tnsNS   ="http://www.fujifilm.com/fb/2021/04/ssm/management/storeddocument/attribute/print";
...
SSMILib.GetStoredDocument = function(sdObj, timeout)
{
  ...
  _ws.soapAction = '"http://www.fujifilm.com/fb/2021/04/ssm/management/storeddocument#GetStoredDocument"';
...
SSMILib.StoredDocument.gsdSuccessCb = function(res)
{
  ...
  var _gsdrNode = res.responseXML.getElementsByTagNameNS(
      "http://www.fujifilm.com/fb/2021/04/ssm/management/storeddocument","GetStoredDocumentResponse");
...
SSMILib.GetStoredDocumentCount = function(sdObj, timeout)
{
  ...
  _ws.soapAction = '"http://www.fujifilm.com/fb/2021/04/ssm/management/storeddocument#GetStoredDocumentCount"';
  _ws.isDeviceReq = true;
...
SSMILib.StoredDocument.gsdCountSuccessCb = function(res)
{
  ...
  var _gsdrNode = res.responseXML.getElementsByTagNameNS(
      "http://www.fujifilm.com/fb/2021/04/ssm/management/storeddocument","GetStoredDocumentCountResponse");
...
SSMILib.DeleteStoredDocument = function(sdObj, timeout)
{
  ...
  _ws.soapAction = '"http://www.fujifilm.com/fb/2021/04/ssm/management/storeddocument#DeleteStoredDocument"';
  _ws.isDeviceReq = true;
  var _targetURL = SSMILib.protocol + SSMILib.host + "/ssm/Management/StoredDocument";
...
SSMILib.StoredDocument.dsdSuccessCb = function(res)
{
  ...
  var _dsdrNode = res.responseXML.getElementsByTagNameNS(
      "http://www.fujifilm.com/fb/2021/04/ssm/management/storeddocument","DeleteStoredDocumentResponse");
